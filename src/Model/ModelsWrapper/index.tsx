...
import ModelsContext, { ProcedureModel } from '../ModelsContext'
...
const ModelsWrapper: React.FC = ({ children }) => {
  ...
  const [registeredModels, setRegisteredModels] = useState<ProcedureModel[]>([])

  const registerModel = useCallback((model: ProcedureModel) => {
